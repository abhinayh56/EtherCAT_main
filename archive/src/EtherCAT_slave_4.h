#ifndef ETHERCAT_SLAVE_4_H
#define ETHERCAT_SLAVE_4_H

#include <ecrt.h>
#include "EtherCAT_slave_base.h"
#include <iostream>

class EtherCAT_slave_4 : public EtherCAT_slave_base
{
public:
    EtherCAT_slave_4() {}
    ...
    void read_pdo()
    {
        ...
        std::cout << "TXPDO_4: " << ACT_POS << ", " << STATUS_WD << ", " << ACT_TOR << ", " << OPMODE_DISP << ", " << ERROR_CODE << ", " << DIG_IN << ", " << ACT_VEL << ", " << ADC_VAL << std::endl;
    }
