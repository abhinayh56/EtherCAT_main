#ifndef ETHERCAT_SLAVE_3_H
#define ETHERCAT_SLAVE_3_H

#include <ecrt.h>
#include "EtherCAT_slave_base.h"
#include <iostream>

class EtherCAT_slave_3 : public EtherCAT_slave_base
{
public:
    EtherCAT_slave_3() {}
    ...
    void read_pdo()
    {
        ...
        std::cout << "TXPDO_3: " << ACT_POS << ", " << STATUS_WD << ", " << ACT_TOR << ", " << OPMODE_DISP << ", " << ERROR_CODE << ", " << DIG_IN << ", " << ACT_VEL << ", " << ADC_VAL << std::endl;
    }
