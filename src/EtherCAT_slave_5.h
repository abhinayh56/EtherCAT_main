#ifndef ETHERCAT_SLAVE_5_H
#define ETHERCAT_SLAVE_5_H

#include <ecrt.h>
#include "EtherCAT_slave_base.h"
#include <iostream>

class EtherCAT_slave_5 : public EtherCAT_slave_base
{
public:
    EtherCAT_slave_5() {}
    ...
    void read_pdo()
    {
        ...
        std::cout << "TXPDO_5: " << ACT_POS << ", " << STATUS_WD << ", " << ACT_TOR << ", " << OPMODE_DISP << ", " << ERROR_CODE << ", " << DIG_IN << ", " << ACT_VEL << ", " << ADC_VAL << std::endl;
    }
